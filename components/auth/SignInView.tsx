        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-xs sm:text-sm text-zinc-400 mt-1">
              Access your personalized CBT dashboard & test series
            </p>
          </div>
          ...
          {isSuccess ? (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-white">Authentication Verified</h3>
              <p className="text-xs sm:text-sm text-zinc-400 max-w-sm mx-auto">
                Welcome back! Directing you to your {role === "student" ? "Student CBT Dashboard" : role === "institute" ? "Institute Portal" : "Mentorship Hub"}...
              </p>
              <div className="pt-4 flex items-center justify-center gap-2">
                <div className="h-1.5 w-1.5 rounded-full bg-white animate-ping" />
                <span className="text-xs font-mono text-zinc-400">Launching Session Token</span>
              </div>
            </motion.div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    type="button"
                    onClick={() => alert("Password reset link feature enabled.")}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <button
                  type="button"
                  onClick={() => {
                    setErrorMessage("Google SSO authentication is initializing.");
                  }}
