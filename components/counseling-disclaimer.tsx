...
export function CounselingDisclaimer() {
  return (
    <div className="rounded-2xl border border-amber-500/30 bg-amber-500/10 p-3 flex gap-2 text-[11px] leading-snug text-amber-900 dark:text-amber-200">
      ...
      <div>
        Prepify provides educational guidance and predictions based on previous years' counseling data.
        ...
        Prepify is not affiliated with MCC, NMC, NTA, or any state counseling authority.
      </div>
    </div>
  );
}
