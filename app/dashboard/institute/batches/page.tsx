  ...
  return (
    <div className="space-y-8">
      <header className="space-y-2">
        ...
        <p className="text-zinc-400">Assign faculty and monitor student cohorts.</p>
      </header>
      ...
      <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-2xl h-[400px] flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <h2 className="text-xl font-medium">No Active Batches</h2>
          <p className="text-zinc-400 text-sm">Create your first batch to begin assigning mentors.</p>
        </div>
      </div>
    </div>
  );
